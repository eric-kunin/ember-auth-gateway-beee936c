...
//   const interests = [
//     { icon: <Music className="w-4 h-4" />, label: 'מוזיקה' },
//     { icon: <Coffee className="w-4 h-4" />, label: 'קפה' },
//     { icon: <Book className="w-4 h-4" />, label: 'קריאה' }
//   ];
...
//   return (
//     <div className="flex items-center justify-center min-h-screen bg-gradient-to-br  p-4" dir="rtl">
//       <motion.div 
...
//               src="https://i.pinimg.com/736x/08/18/84/081884394818f74a312defa0d1fef2e5.jpg" 
//               alt="Profile" 
...
//                 >
//                   <div className="absolute top-0 left-0 right-0 p-4 text-center text-white border-b border-white/10">
...
//                   animate={{ opacity: 1, y: 0 }}
//                   exit={{ opacity: 0, y: 10 }}
//                   className="absolute bottom-full left-0 w-full backdrop-blur-xl bg-[#392467]/90 rounded-2xl shadow-xl p-4 mb-2 z-20"
//                 >
...
//                     className="w-full mt-3 p-2 text-center text-white/70hover:text-white text-sm transition-colors duration-300"
//                   >
//                     ביטול
//                   </motion.button>
//                 </motion.div>
...
//                   <h2 className="text-2xl font-bold">שרה, 25</h2>
